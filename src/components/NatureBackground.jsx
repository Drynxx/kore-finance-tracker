...
export const NatureBackground = () => {
    ...
    return (
        <div className="fixed top-0 left-0 w-full h-[100dvh] -z-50 overflow-hidden bg-slate-900">
            <AnimatePresence mode="wait">
                {wallpaperUrl ? (
                    ...
                    >
                        ...
                        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1449034446853-66c86144b0ad?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center opacity-40 blur-sm will-change-transform backface-hidden" />
                        <div className="absolute inset-0 bg-gradient-to-b from-slate-900/50 via-slate-900/20 to-slate-900/80" />
                    </motion.div>
                )}
            </AnimatePresence>
